...
<head>
    ...
    <title>Tambah Kategori - IT Del Press</title>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-4 lg:mx-auto">
                        ...
                        <div class="hidden md:block">
                            ...
                            <p class="text-sm text-gray-600">Tambah Kategori Baru</p>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <a href="{{ route('categories.index') }}" class="text-gray-600 hover:text-gray-900 flex items-center">
                        ...
                        <form action="{{ route('categories.store') }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Nama kategori akan digunakan untuk mengelompokkan publikasi.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="slug" id="slug" value="{{ old('slug') }}" 
                                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-600 focus:border-transparent transition duration-300" 
                                           placeholder="Slug akan dibuat otomatis" readonly>
                                    <p class="mt-1 text-sm text-gray-500">Slug digunakan untuk URL. Biarkan kosong untuk generate otomatis.</p>
                                </div>
