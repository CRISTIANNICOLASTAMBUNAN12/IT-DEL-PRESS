...
<head>
    ...
    <title>Kategori - IT Del Press</title>
...
<a href="{{ route('publication.index') }}"
   class="group flex items-center px-4 py-3 text-sm font-medium rounded-md 
          {{ request()->routeIs('publication.index') ? 'text-gray-900 bg-gray-100' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
...
<a href="{{ route('categories.index') }}"
   class="group flex items-center px-4 py-3 text-sm font-medium rounded-md 
          {{ request()->routeIs('categories.index') ? 'text-gray-900 bg-gray-100' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-4 lg:mx-auto">
                        ...
                        <div class="hidden md:block">
                            ...
                            <p class="text-sm text-gray-600">Manajemen Kategori</p>
                        </div>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p class="text-gray-600">Kelola kategori publikasi Anda</p>
                    </div>
                    <a href="{{ route('categories.create') }}" class="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-medium py-2 px-4 rounded-lg shadow-md transition-all duration-300 transform hover:-translate-y-1 flex items-center">
...
<tbody class="bg-white divide-y divide-gray-200">
    ...
    <tr class="hover:bg-gray-50 transition-colors duration-150">
        ...
        <!-- Kolom Jumlah Publikasi -->
        <td class="px-6 py-4 whitespace-nowrap">
            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                {{ $category->publications_count }} Publikasi
            </span>
        </td>
    ...
    <tr>
        <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">
            Tidak ada kategori yang tersedia. Mulailah dengan menambahkan kategori baru.
        </td>
    </tr>
    @endforelse
</tbody>
