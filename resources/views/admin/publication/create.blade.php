...
<head>
    ...
    <title>Tambah Publikasi - IT Del Press</title>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-4 lg:mx-auto">
                        ...
                        <div class="hidden md:block">
                            ...
                            <p class="text-sm text-gray-600">Tambah Publikasi Baru</p>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-6">
                            <h2 class="text-xl font-semibold text-gray-800">Form Tambah Publikasi</h2>
                        ...
                        <form action="{{ route('publication.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Judul yang jelas dan deskriptif</p>
                                </div>
                                <div x-data="{ authors: [''] }" class="space-y-2">
                            ...
                            <div>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">File Publikasi (PDF)</label>
