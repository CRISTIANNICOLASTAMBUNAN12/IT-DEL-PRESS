...
<head>
    ...
    <title>Pengumuman - IT Del Press</title>
        ...
        <div class="sidebar bg-white shadow-xl h-full flex flex-col" 
            ...
            <div class="flex-1 overflow-y-auto py-4">
                <nav class="px-2 space-y-1">
                    ...
                    <!-- Announcements -->
                    <a href="{{ route('announcement.index') }}" class="group flex items-center px-4 py-3 text-sm font-medium rounded-md text-gray-900 bg-gray-100">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-4 lg:mx-auto">
                        ...
                        <div class="hidden md:block">
                            ...
                            <p class="text-sm text-gray-600">Manajemen Pengumuman</p>
                        </div>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p class="text-gray-600">Kelola semua pengumuman Anda</p>
                    </div>
                    <a href="{{ route('announcement.create') }}" class="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-medium py-2 px-4 rounded-lg shadow-md transition-all duration-300 transform hover:-translate-y-1 flex items-center">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <!-- Kolom Judul Pengumuman -->
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">{{ $announcement->title }}</div>
                                                <div class="text-xs text-gray-500 line-clamp-1">{{ strip_tags($announcement->content) }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-2">
                                            <a href="{{ route('announcement.edit', $announcement->id) }}" class="text-indigo-600 hover:text-indigo-900">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                </svg>
                                            </a>
                                            <form action="{{ route('announcement.destroy', $announcement->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengumuman ini?')">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">
                                        Tidak ada pengumuman yang tersedia. Mulailah dengan menambahkan pengumuman baru.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
